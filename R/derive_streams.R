...
#' \href{https://grass.osgeo.org/grass74/manuals/r.stream.extract.html}{r.stream.extract}.
...
#' \href{https://grass.osgeo.org/grass74/manuals/r.stream.extract}{r.stream.extract}.
